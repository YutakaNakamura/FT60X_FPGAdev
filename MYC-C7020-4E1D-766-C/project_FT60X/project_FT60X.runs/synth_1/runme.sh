...
HD_PWD='F:/develop/Data/Xilinx/Workspace/MYC-C7020-4E1D-766-C/project_FT60X/project_FT60X.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ps_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_ps_wrapper.tcl
