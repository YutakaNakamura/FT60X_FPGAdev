...
HD_PWD='F:/develop/Data/Xilinx/Workspace/MYC-C7020-4E1D-766-C/project_FT60X/project_FT60X.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ps_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_ps_wrapper.tcl -notrace
