...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DATA [ create_bd_port -dir IO -from 31 -to 0 DATA ]
  set D_CLK [ create_bd_port -dir I -type clk D_CLK ]
  ...
  set clkout_0 [ create_bd_port -dir O clkout_0 ]
  set led_0 [ create_bd_port -dir O led_0 ]

  # Create instance: FT60X_AXI_0, and set properties
  set FT60X_AXI_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:FT60X_AXI:1.0 FT60X_AXI_0 ]

  # Create instance: clockctrl_0, and set properties
  set clockctrl_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:clockctrl:1.0 clockctrl_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins clockctrl_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins FT60X_AXI_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net FT60X_AXI_0_output_enable_N [get_bd_ports OE_N] [get_bd_pins FT60X_AXI_0/OE_N]
  connect_bd_net -net FT60X_AXI_0_read_enable_N [get_bd_ports RD_N] [get_bd_pins FT60X_AXI_0/RD_N]
  connect_bd_net -net FT60X_AXI_0_write_enable_N [get_bd_ports WR_N] [get_bd_pins FT60X_AXI_0/WR_N]
  connect_bd_net -net Net [get_bd_ports DATA] [get_bd_pins FT60X_AXI_0/DATA]
  connect_bd_net -net clockctrl_0_clkout [get_bd_ports clkout_0] [get_bd_pins clockctrl_0/clkout]
  connect_bd_net -net clockctrl_0_led [get_bd_ports led_0] [get_bd_pins clockctrl_0/led]
  connect_bd_net -net data_clock_0_1 [get_bd_ports D_CLK] [get_bd_pins FT60X_AXI_0/CLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports FCLK_CLK0_0] [get_bd_pins FT60X_AXI_0/s00_axi_aclk] [get_bd_pins clockctrl_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net receive_full_N_0_1 [get_bd_ports RXF_N] [get_bd_pins FT60X_AXI_0/RXF_N]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins FT60X_AXI_0/s00_axi_aresetn] [get_bd_pins clockctrl_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net transmit_empty_N_0_1 [get_bd_ports TXE_N] [get_bd_pins FT60X_AXI_0/TXE_N]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins processing_system7_0/SDIO1_CDN] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs FT60X_AXI_0/S00_AXI/S00_AXI_reg] SEG_FT60X_AXI_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs clockctrl_0/S00_AXI/S00_AXI_reg] SEG_clockctrl_0_S00_AXI_reg
