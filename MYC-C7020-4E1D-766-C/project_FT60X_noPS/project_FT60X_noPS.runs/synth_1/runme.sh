...
HD_PWD='F:/develop/Data/Xilinx/Workspace/MYC-C7020-4E1D-766-C/project_FT60X_noPS/project_FT60X_noPS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FT60XDriver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FT60XDriver.tcl
