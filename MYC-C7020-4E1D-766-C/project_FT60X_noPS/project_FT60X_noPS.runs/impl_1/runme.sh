...
HD_PWD='F:/develop/Data/Xilinx/Workspace/MYC-C7020-4E1D-766-C/project_FT60X_noPS/project_FT60X_noPS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FT60XDriver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FT60XDriver.tcl -notrace
