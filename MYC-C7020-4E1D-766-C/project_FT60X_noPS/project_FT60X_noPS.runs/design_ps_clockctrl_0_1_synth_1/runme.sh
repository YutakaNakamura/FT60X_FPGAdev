...
HD_PWD='F:/develop/Data/Xilinx/Workspace/MYC-C7020-4E1D-766-C/project_PS_Check/project_PS_Check.runs/design_ps_clockctrl_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ps_clockctrl_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_ps_clockctrl_0_1.tcl
